...
export class WorkerClient {
    ...
    async initBatch(params) {
        return retryWithBackoff(() => this.request('POST', '/api/batches/init', params), {
    ...
    async startFileUpload(batchId, params) {
        return retryWithBackoff(() => this.request('POST', `/api/batches/${batchId}/files/start`, params), {
            maxRetries: this.maxRetries,
            initialDelay: this.retryInitialDelay,
            maxDelay: this.retryMaxDelay,
            jitter: this.retryJitter,
    ...
    async completeFileUpload(batchId, params) {
        return retryWithBackoff(() => this.request('POST', `/api/batches/${batchId}/files/complete`, params), {
            maxRetries: this.maxRetries,
            initialDelay: this.retryInitialDelay,
            maxDelay: this.retryMaxDelay,
            jitter: this.retryJitter,
    ...
    async finalizeBatch(batchId) {
        return retryWithBackoff(() => this.request('POST', `/api/batches/${batchId}/finalize`, {}), {
            maxRetries: this.maxRetries,
            initialDelay: this.retryInitialDelay,
            maxDelay: this.retryMaxDelay,
            jitter: this.retryJitter,
